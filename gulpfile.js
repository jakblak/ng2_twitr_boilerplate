...
gulp.task('copy:libs', function (done) {
    sequence('clean', 'copy:vendor', 'copy:rxjs', 'copy:angular', 'copy:bootstrap', 'copy:socketIO', 'copy:moment', 'copy:ng2-bootstrap', done);
});
...
gulp.task('copy:moment', function() {
    return gulp
      .src([nodeModulesPath + '/moment/**/*'])
      .pipe(gulp.dest(libPath + '/moment'));
});

gulp.task('copy:ng2-bootstrap', function() {
    return gulp
      .src([nodeModulesPath + '/ng2-bootstrap/**/*'])
      .pipe(gulp.dest(libPath + '/ng2-bootstrap'));
});
